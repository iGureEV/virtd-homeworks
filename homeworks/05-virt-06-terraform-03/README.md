...
Выполнена доработка заданий после увлечения лимита создания внешних IP через поддержку облака.  
А так же доработка сценариев Terraform - упрощение выражений.
![Доработка с внешним IP без NAT](Доработка_с_внешним_IP_без_NAT.png)

------
------

![Удаление всех созданных ресурсов.png](Удаление_всех_созданных_ресурсов.png)
