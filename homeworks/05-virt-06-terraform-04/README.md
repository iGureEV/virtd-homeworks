...
_**Выполнение**_:  
1. Демонстрация стейта, удаление vpc и вм, проверка стейта, и восстановление удалённых ресурсов, проверка стейта после восстановления.

    ![ВМ](task_03_1.png)  

2. Демонстрация отсутствия значимых изменений в стейте.  
...
_**Выполнение**_:  
1. Установить плагин `aws`
2. Прописал настройки плагина
3. Для сервисного аккаута создал статические ключи доступа
4. Дал сервисному аккаунту права на хранилище
5. После этого создалось S3

    Инициализация:  
    ![init](task_06_1.png)  
    Попытка установки со статическим ключом:  
    ![apply](task_06_2.png)  
    Попытка установки со статическим ключом и правами на хранилище:   
    ![fix](task_06_3.png)  
    Проверка в облаке:
    ![проверка](task_06_4.png)  
